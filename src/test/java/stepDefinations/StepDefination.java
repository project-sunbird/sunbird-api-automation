...
public void user_calls_with_http_request(String resource, String method) {
	...
	public void readTocFilepathToUploadWithAsPathparam(String bookId) throws IOException {
		...
		res=given().baseUri(util.baseuri)
				...
				.multiPart("file",new File("https://sunbirdstagingpublic.blob.core.windows.net/sunbird-content-staging/content/textbook/toc/do_213298858288390144134_upload-book_1623396198775.csv"))
